<template>
    <section class="main">
        <div class="drag-box-left">
            ...
            <div class="drag-list" draggable="true" v-for="list in data1" :key="list.id" :data-id="list.id" @dragstart="dragstartEvent" @dragend="dragendEvent" @dragenter="dragenterEvent" @dragleave="dragleaveEvent" @dragover="dragoverEvent">{{list.title}}</div>
        </div>
    </section>
</template>
